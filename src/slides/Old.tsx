    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        <View style={styles.alignTxt}>
          <Image style={styles.img} source={getImages("horse")} />
        ...
        <View style={styles.alignTxt}>
          <Image style={styles.img} source={getImages("bull")} />
        ...
        <View style={styles.alignTxt}>
          <Image style={styles.img} source={getImages("ca")} />
        ...
        <View style={styles.child}>
          <Image style={styles.img} source={getImages("horsee")} />
        <Image style={styles.img} source={getImages("cameldrive")} />
        <Image style={styles.img} source={getImages("bulldrive")} />
        </View>
